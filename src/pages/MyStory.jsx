...
let data = {
    paragraphs:
        [
            ...
            "Since enrolling in the MCIT program, I have gained valuable experience and technical skills in software development, including distributed systems, databases, computer networks, algorithms, computer and network security, artificial intelligence, machine learning, big data, cloud computing, and web applications. My passion for user-centered design and clean/maintainable code elevates my projects to the next level. ",
